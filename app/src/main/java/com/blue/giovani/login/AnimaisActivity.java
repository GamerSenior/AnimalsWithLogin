package com.blue.giovani.login;
...
import com.blue.giovani.login.dao.AnimalDao;
import com.blue.giovani.login.dao.DaoAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(AnimaisActivity.this, NovoAnimalActivity.class);
                startActivity(i);
            }
        });
    }
